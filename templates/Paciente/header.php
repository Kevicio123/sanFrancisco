...
<body>
  ...
  <div class="container">
    <!-- Navbar brand -->
    <a href="<?php echo $url_base?>index3.php">
      <img
    ...
    <div class="collapse navbar-collapse" id="navbarButtonsExample">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="<?php echo $url_base?>index3.php">Consultorio San Francisco</a>
        </li>
      </ul>
      <!-- Left links -->
      ...
      <div class="btn-group btn-group-toggle" data-toggle="buttons">
        ...
        <div>
        <a class="btn btn-primary" href="<?php echo $url_base?>cerrar.php" role="button">Cerrar Sesión</a>
        </div>
