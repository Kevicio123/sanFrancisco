...
?>
    ...
    <div class="card">
        ...
        <div class="table-responsive-sm">
            <table class="table table-striped table-hover" id="tabla">
                ...
                { ?>
                    ...
                    <tr class="">
                        ...
                        <td><a href="../secciones/examen/<?php echo $examen['examen']?>" download="examenDescarga" 
                        class="btn btn-primary">Descargar</a></td>
                        
                        <td>
                    
                        <a name="" id="" class="btn btn-secondary" 
                         href="../secciones/examen/edit.php?txtID=<?php echo $examen['idExamen']; ?>" role="button">Editar</a>
                        |
                        <a name="" id="" class="btn btn-danger" 
                         href="javascript:borrarExamen2(<?php echo $examen['idExamen']; ?>);" role="button">Eliminar</a>
            ...
            href="../secciones/examen/create.php" role="button">Crear Exámen</a>
